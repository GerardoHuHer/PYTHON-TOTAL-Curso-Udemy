...
letras = []
for i in range (0, 3):
    letras.append(input(f'Ingresa la {i + 1}° letra: ').lower())
    cantLetras = text.count(letras[i])
    print(f'La letra "{letras[i]}", aparece {cantLetras} veces')
...
print('\n')
bool = 'python' in textList
if bool == True:
    print("La palabra Python sí aparece en el texto")
else:
